    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <button type="button" class="btn btn-primary btn-block botaoCancelar" id="cancelarCadastrarImovelBotao">Cancelar cadastro</button>
            </div>
        </div>
    </div>
    <div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Digite a identificação do seu imóvel" id="identificacaoImovel" name="identificacaoImovel">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control cep" type="text" placeholder="Digite o CEP do seu imóvel" id="cepImovel" name="cepImovel">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control siglaEstado" type="text" placeholder="Digite a sigla do estado do imóvel" id="estadoImovel" name="estadoImovel">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="cidadeImovel" id="cidadeImovel" placeholder="Digite a cidade do seu imóvel" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="bairroImovel" id="bairroImovel" placeholder="Digite o bairro do seu imóvel" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="logradouroImovel" id="logradouroImovel" placeholder="Digite a rua do seu imóvel" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="numeroImovel" id="numeroImovel" placeholder="Digite o número do seu imóvel" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-1">
                    <div class="form-group">
                        <div class="animated-radio-button">
                            <label>
                                <input type="radio" name="tipoImovel" value="1" checked class="radioCasa"><span class="label-text">Casa</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <div class="animated-radio-button">
                            <label>
                                <input type="radio" name="tipoImovel" value="2" class="radioApartamento"><span class="label-text">Apartamento</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="edificioImovel" id="edificioImovel" placeholder="Digite o nome do edificio do seu apartamento" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="blocoImovel" id="blocoImovel" placeholder="Digite o nome do bloco do seu apartamento" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="numeroApImovel" id="numeroApImovel" placeholder="Digite o número do seu apartamento" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
...
<div>
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <button type="button" class="btn btn-primary btn-block botaoCadastrar" id="cadastrarImovelBotao">Cadastrar novo imóvel</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group input-group">
                ...
                <input name="consulta" id="txt_consulta" placeholder="Pesquise um imóvel" type="text" class="form-control">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-header">
                ...
                <div class="pull-right">
                    ...
                    <div class="btn-group">
                        ...
                        <a class="btn btn-danger btn-apagar" href="control/imovelController.php?req=excluir&id=<?php echo $id;?>">
            ...
            <div class="card-body informacoes" id="toggle-<?php echo $id; ?>">
                <ul class="list-group">
                    ...
                    <?php if($tipo == 2){ ?>
                        ...
                        <li class="list-group-item"><strong>NÚMERO DO APARTAMENTO:</strong> <?php echo $i->getNumeroAp(); ?> </li>
                    <?php } ?>
                </ul>
            </div>
